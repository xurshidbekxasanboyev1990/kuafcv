...
const CATEGORY_LABEL = 'Tashkiliy va yetakchilik';
const CATEGORY_ICON = '👔';

export default function LeadershipPortfolioPage() {
      ...
      <div className="p-4 md:p-8">
        ...
        <div className="flex items-start justify-between mb-8">
          <div>
            ...
            <p className="text-sm text-red-500 mt-2">
              Jamoa boshqaruvi, tadbirlar tashkil etish, talabalar kengashi, loyihalar yetakchiligi
            </p>
          </div>
        ...
        {loadingData ? (
          ...
          <div className="text-center py-12 bg-white rounded-xl border border-red-100">
            <Users className="mx-auto text-red-300 mb-4" size={64} />
            <h3 className="text-lg font-medium text-red-800 mb-2">Hozircha yetakchilik tajribasi yo'q</h3>
            <p className="text-red-600 mb-4">Birinchi yetakchilik tajribangizni qo'shing</p>
      ...
      {showModal && (
        <LeadershipPortfolioModal
          ...
          onSuccess={() => {
            setShowModal(false);
            fetchPortfolios();
            setMessage({ type: 'success', text: 'Yetakchilik tajribasi qo\'shildi' });
...
function LeadershipPortfolioModal({ onClose, onSuccess }: { onClose: () => void; onSuccess: () => void }) {
  ...
  const validateFile = (file: File): string | null => {
    ...
    if (!ALLOWED_TYPES.includes(file.type)) {
      return `Fayl turi qo'llab-quvvatlanmaydi: ${file.type}. Faqat PDF, DOCX, JPG, PNG.`;
    }

    // Extension validation as additional security layer
    const extension = file.name.toLowerCase().slice(file.name.lastIndexOf('.'));
    if (!ALLOWED_EXTENSIONS.includes(extension)) {
      return `Fayl kengaytmasi noto'g'ri: ${extension}. Faqat: ${ALLOWED_EXTENSIONS.join(', ')}`;
    }
  ...
  // Tag management functions with validation
  const addTag = () => {
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full p-6 md:p-8 max-h-[90vh] overflow-y-auto transform transition-all animate-slideUp">
        ...
        <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl md:text-2xl font-bold text-gray-800">Yetakchilik Tajribasi</h2>
              <p className="text-sm text-gray-500 mt-0.5">Jamoa boshqaruvi va tashkilotchilik</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              required
              maxLength={200}
              placeholder="Masalan: Talabalar kengashi raisi"
              ...
              aria-label="Lavozim yoki rol sarlavhasi"
            />
            <p className="text-xs text-gray-500">Lavozimingiz yoki rolni kiriting</p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              rows={4}
              maxLength={1000}
              placeholder="Vazifalaringiz, erishgan yutuqlar, mas'uliyatlar haqida batafsil..."
              ...
              aria-label="Yetakchilik tajribasi tavsifi"
            />
            <p className="text-xs text-gray-500">Jamoangiz hajmi, erishgan natijalar va mas'uliyatlarni kiriting</p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                aria-label="Tasdiqlovchi hujjatlar tanlash"
              />
              {files.length > 0 && (
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-500">Masalan: jamoa, loyiha, tashkilotchilik</p>
          </div>

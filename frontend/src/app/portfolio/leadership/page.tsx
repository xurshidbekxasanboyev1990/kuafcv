...
export default function LeadershipPortfolioPage() {
  ...
  const fetchPortfolios = async () => {
    try {
      ...
      const leadershipItems = data.filter((item: PortfolioItem) => item.category === CATEGORY);
      setItems(leadershipItems);
    } catch (error) {
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Jamoa boshqaruvi, tadbirlar tashkil etish va ijtimoiy faollik.
              </p>
            </div>
          </div>
            ...
            <Card className="border-dashed">
              <CardContent className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <p className="text-muted-foreground max-w-sm mb-6">
                  Siz hali hech qanday yetakchilik tajribasini kiritmagansiz.
                </p>
...
function LeadershipPortfolioModal({
  onClose,
  onSuccess,
}: {
  onClose: () => void;
      ...
      <Card className="w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl border-primary/20">
        <CardHeader className="border-b sticky top-0 bg-card z-10 flex flex-row items-center justify-between py-4">
          <div className="flex items-center gap-2">
            ...
            <CardTitle>Yetakchilik Tajribasi Qo'shish</CardTitle>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="description">
                Tavsif (Mas'uliyatlar)
              </Label>
              <Textarea
                id="description"
                value={formData.description}
                onChange={(e) => setFormData({ ...formData, description: e.target.value })}
                placeholder="Qanday vazifalarni bajardingiz? Qanday natijalarga erishdingiz?"
                rows={5}
                maxLength={1000}
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  placeholder="Liderlik, Tashkilotchilik, Volontyorlik..."
                  className="flex-1"
                />
            ...
            <div className="space-y-3">
              <Label className="flex items-center gap-2">
                ...
                Fayllar (Tasdiqlovchi hujjatlar)
              </Label>

        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-2 text-lg">
              Olimpiada natijalari, tanlovlar, stipendiyalar va rasmiy e'tiroflar.
            </p>
          </div>
          <Button
        ...
        {loadingData ? (
          ...
          <Card className="border-dashed">
            <CardContent className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Hozircha mukofotlar yo'q</h3>
              <p className="text-muted-foreground max-w-sm mb-6">
                Birinchi yutug'ingizni qo'shing va muvaffaqiyatlaringizni namoyish eting.
              </p>
      ...
      {showModal && (
        <AwardsPortfolioModal
          ...
          onSuccess={() => {
            setShowModal(false);
            fetchPortfolios();
            setMessage({ type: 'success', text: 'Mukofot muvaffaqiyatli qo\'shildi' });
        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-bold">Mukofot va Yutuqlar</h2>
                <p className="text-sm text-muted-foreground">Olimpiada va tanlovlar diplomi yoki sertifikati</p>
              </div>
            </div>
            <Button
              variant="ghost"
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                maxLength={200}
                placeholder="Masalan: Respublika olimpiadasi I o'rin"
              />
              <div className="flex justify-between text-xs text-muted-foreground">
                <span>Mukofot nomini kiriting</span>
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                rows={4}
                maxLength={1000}
                placeholder="O'rin, fan/yo'nalish, ishtirokchilar soni, erishgan yutuqlar..."
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <p className="text-xs text-muted-foreground">PDF, DOCX, JPG (maks 50MB)</p>
              </div>

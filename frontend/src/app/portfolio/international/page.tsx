...
// Using generic standard icon for consistency
const CATEGORY_ICON = '🌍';
...
export default function InternationalPortfolioPage() {
  ...
  const fetchPortfolios = async () => {
    try {
      ...
      const internationalItems = data.filter((item: PortfolioItem) => item.category === CATEGORY);
      setItems(internationalItems);
    } catch (error) {
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Xalqaro hamkorlik, chet til sertifikatlari, grant va almashinuv dasturlari.
              </p>
            </div>
          </div>
            ...
            <Card className="border-dashed">
              <CardContent className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <p className="text-muted-foreground max-w-sm mb-6">
                  Siz hali hech qanday xalqaro tajriba yoki til sertifikatini kiritmagansiz.
                </p>
...
function InternationalPortfolioModal({
  onClose,
  onSuccess,
}: {
  onClose: () => void;
      ...
      <Card className="w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl border-primary/20">
        <CardHeader className="border-b sticky top-0 bg-card z-10 flex flex-row items-center justify-between py-4">
          <div className="flex items-center gap-2">
            ...
            <CardTitle>Xalqaro Tajriba Qo'shish</CardTitle>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="title" className="after:content-['*'] after:ml-0.5 after:text-destructive">
                Sarlavha (Sertifikat yoki Dastur nomi)
              </Label>
              <Input
                id="title"
                value={formData.title}
                onChange={(e) => setFormData({ ...formData, title: e.target.value })}
                placeholder="Masalan: IELTS 7.5, Harvard CS50, Erasmus+"
                maxLength={200}
                required
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Qachon, qayerda, qanday natijaga erishdingiz?"
                rows={5}
                maxLength={1000}
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  placeholder="English, Exchange, Grant..."
                  className="flex-1"
                />

...
export default function TechnicalPortfolioPage() {
  ...
  const fetchPortfolios = async () => {
    try {
      ...
      const technicalItems = data.filter((item: PortfolioItem) => item.category === CATEGORY);
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Dasturlash tajribasi, IT sertifikatlar, texnik ko'nikmalar va kod loyihalar.
              </p>
            </div>
          </div>
            ...
            <Card className="border-dashed">
              <CardContent className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <p className="text-muted-foreground max-w-sm mb-6">
                  Siz hali hech qanday texnik tajriba kiritmagansiz.
                </p>
...
function TechnicalPortfolioModal({
  onClose,
  onSuccess,
}: {
  onClose: () => void;
      ...
      <Card className="w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl border-primary/20">
        <CardHeader className="border-b sticky top-0 bg-card z-10 flex flex-row items-center justify-between py-4">
          <div className="flex items-center gap-2">
            ...
            <CardTitle>Texnik Tajriba Qo'shish</CardTitle>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="title" className="after:content-['*'] after:ml-0.5 after:text-destructive">
                Sarlavha (Ko'nikma yoki Sertifikat)
              </Label>
              <Input
                id="title"
                value={formData.title}
                onChange={(e) => setFormData({ ...formData, title: e.target.value })}
                placeholder="Masalan: Advanced Python, AWS Certified Cloud Practitioner"
                maxLength={200}
                required
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Qaysi loyihalarda ishlatgansiz? Qanday natijalarga erishdingiz?"
                rows={5}
                maxLength={1000}
            ...
            <div className="space-y-3">
              <Label className="flex items-center gap-2">
                ...
                Fayllar (Sertifikatlar)
              </Label>

              <div
                className={`border-2 border-dashed rounded-xl p-6 flex flex-col items-center justify-center text-center cursor-pointer relative group transition-all duration-200 ${isDragging

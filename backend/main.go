	...
	api := r.Group("/api")
	{
		...
		protected.Use(middleware.AuthMiddleware())
		{
			...
			admin.Use(middleware.RequireRole(models.RoleAdmin))
			{
				...
				admin.GET("/webhooks/events", handlers.GetWebhookEvents)
				admin.GET("/webhooks/:id", handlers.GetWebhook)
				...
				admin.PUT("/webhooks/:id/toggle", handlers.ToggleWebhook)
				admin.POST("/webhooks/:id/test", handlers.TestWebhook)
				admin.GET("/webhooks/:id/logs", handlers.GetWebhookLogs)
				admin.DELETE("/webhooks/:id/logs", handlers.ClearWebhookLogs)
